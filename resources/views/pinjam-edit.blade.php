                                            ...
                                            <div class="form-group">
                                                <div class="form-row mb-3">
                                                    <div class="col">
                                                        ...
                                                        <input value="" type="date" class="form-control" name="date_returned" id="date_returned" required>
                                                    </div>
                                                    <div class="col">
                                                        <label for="denda">Denda</label>
                                                        <input value="" type="number" class="form-control" name="denda" id="denda" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <a onclick='this.parentNode.submit(); return false;' class="btn btn-success btn-icon-split" id="satuan_delete">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-check"></i>
                                                </span>
                                                <span class="text">Selesai pinjam</span>
                                            </a>
                                        </form>
                                    </div>
                                </div>
